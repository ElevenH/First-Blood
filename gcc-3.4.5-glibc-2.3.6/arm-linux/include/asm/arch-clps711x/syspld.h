...
#define PLD_KBD		SYSPLD_REG(__u32, 0x000008)
#define PLD_KBD_WAKE		(1 << 1)
#define PLD_KBD_EN		(1 << 0)
#define PLD_SPI		SYSPLD_REG(__u32, 0x00000c)
#define PLD_SPI_EN		(1 << 0)
#define PLD_IO		SYSPLD_REG(__u32, 0x000010)
...
#define PLD_IRDA	SYSPLD_REG(__u32, 0x000014)
#define PLD_IRDA_EN		(1 << 0)
#define PLD_COM2	SYSPLD_REG(__u32, 0x000018)
#define PLD_COM2_EN		(1 << 0)
#define PLD_COM1	SYSPLD_REG(__u32, 0x00001c)
#define PLD_COM1_EN		(1 << 0)
#define PLD_AUD		SYSPLD_REG(__u32, 0x000020)
...
#define PLD_CF		SYSPLD_REG(__u32, 0x000024)
...
#define PLD_SDC		SYSPLD_REG(__u32, 0x000028)
#define PLD_SDC_INT_EN		(1 << 2)
#define PLD_SDC_WP		(1 << 1)
#define PLD_SDC_CD		(1 << 0)
#define PLD_FPGA	SYSPLD_REG(__u32, 0x00002c)
#define PLD_CODEC	SYSPLD_REG(__u32, 0x400000)
#define PLD_CODEC_IRQ3		(1 << 4)
#define PLD_CODEC_IRQ2		(1 << 3)
#define PLD_CODEC_IRQ1		(1 << 2)
#define PLD_CODEC_EN		(1 << 0)
#define PLD_BRITE	SYSPLD_REG(__u32, 0x400004)
#define PLD_BRITE_UP		(1 << 1)
#define PLD_BRITE_DN		(1 << 0)
#define PLD_LCDEN	SYSPLD_REG(__u32, 0x400008)
#define PLD_LCDEN_EN		(1 << 0)
#define PLD_ID		SYSPLD_REG(__u32, 0x40000c)
#define PLD_TCH		SYSPLD_REG(__u32, 0x400010)
#define PLD_TCH_PENIRQ		(1 << 1)
#define PLD_TCH_EN		(1 << 0)
#define PLD_GPIO	SYSPLD_REG(__u32, 0x400014)
